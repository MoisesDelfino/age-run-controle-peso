        ...
        if (response.ok) {
            ...
            if (data.authenticated && data.usuario) {
                ...
                if (usuario.altura) {
                    ...
                    if (imcContainer) {
                        imcContainer.innerHTML = '<p class="info-message">⚠️ Informe sua altura na aba <a href="/controle/pesagem" style="color: var(--primary-color); font-weight: bold;">Pesagem</a> para calcular o IMC</p>';
                    }
                }
            }
        }
